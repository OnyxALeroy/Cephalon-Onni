...
def get_server_status(client: MongoClient) -> dict:
...
def describe_table(
    client: MongoClient, table_name: str, db_name: str = "cephalon_onni"
) -> None:
...
def list_tables(client: MongoClient, db_name: str = "cephalon_onni") -> List[str]:
